...
class _HomePageState extends State<HomePage> {
            ...
            return CustomScrollView(
              slivers: [
                ...
                if (videoState is VideoLoading)
                  ...
                  SliverFillRemaining(
                    child: _buildErrorState(videoState.message),
                  )
                else if (videoState is VideoLoaded && videoState.filteredVideos.isEmpty)
                  SliverFillRemaining(
                    child: _buildEmptyState(),
                  )
                else if (videoState is VideoLoaded)
                  ..._buildVideoContent(videoState),
              ],
            );
          },
        );
  ...
  List<Widget> _buildVideoContent(VideoLoaded videoState) {
              ...
              return SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  if (bookmarkedVideos.isNotEmpty)
                    _buildBookmarksSection(bookmarkedVideos, isPremium, sections),
                  // Video list
                  ...videoState.filteredVideos.map((video) => Padding(
